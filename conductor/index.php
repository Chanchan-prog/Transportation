...
if (!isset($_SESSION['user_type']) || $_SESSION['user_type'] !== 'conductor') {
    header("Location: ../index.php");
    exit();
}

// Get conductor's statistics
...
<html>
<head>
    <title>Donsal Track - Conductor</title>
        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link" href="#"><i class="fas fa-qrcode me-2"></i> Scan Ticket</a>
                    <a class="nav-link" href="#"><i class="fas fa-clipboard-list me-2"></i> Trip Records</a>
                </nav>
            </div>
            ...
            <div class="col-md-10">
                ...
                <div class="top-bar d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="me-3"><?php echo htmlspecialchars($_SESSION['name']); ?> conductor</span>
